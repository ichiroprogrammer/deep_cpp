...
```cpp
    // @@@ example/cpp_idiom/lack_of_cohesion_ut.cpp #0:0 begin
```
...
```cpp
    // @@@ example/cpp_idiom/lack_of_cohesion_ut.cpp #0:1 begin
```
...
```cpp
    // @@@ example/cpp_idiom/spurious_wakeup_ut.cpp #0:0 begin
```

std::condition_variable::wait()の第2引数を下記のようにすることでこの現象を回避できる。

```cpp
    // @@@ example/cpp_idiom/spurious_wakeup_ut.cpp #1:0 begin
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #0:0 begin
```

bird::flyのオーバーライド関数(penguin::fly)について、[リスコフの置換原則(LSP)](---)に反した例を下記する。

```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #0:1 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #0:2 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #1:0 begin
```

この誤用を改めた例を以下に示す。

```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #2:0 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #2:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #3:0 begin
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #6:0 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #6:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #7:0 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #7:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #4:0 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #4:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/class_relation_ut.cpp #5:0 begin
    // @@@ example/cpp_idiom/class_relation_ut.cpp #5:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/override_overload_ut.cpp #0:0 begin
```
...
```cpp
    // @@@ example/cpp_idiom/override_overload_ut.cpp #0:1 begin -1
```
...
```cpp
    // @@@ example/cpp_idiom/most_vexing_parse_ut.cpp #0:0 begin

    // @@@ example/cpp_idiom/most_vexing_parse_ut.cpp #0:1 begin -1
```
