&emsp;&emsp;&emsp; [車輪の再発明](cpp_idioms.md#SS_8_13_3)  
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_8_11_6)の例を示す。
...
なお、このパターンは、[std::enable_shared_from_this](stdlib_and_concepts.md#SS_7_5_3)の使用において前提知識となっている。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_8_13_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_8_11_7)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_8_9_3)が起こるためである。
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_8_11_9)によって下記テーブルのように定義する。
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_8_9_1)」参照)。
...
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_8_11_10_2)によって下記テーブルのように定義する。
...
## コーディングスタイル <a id="SS_8_8"></a>
### AAAスタイル <a id="SS_8_8_1"></a>
...
## オブジェクトのコピー <a id="SS_8_9"></a>
### シャローコピー <a id="SS_8_9_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_8_9_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_8_9_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_8_9_1)が発生させる問題を回避したコピーである。
...
## C++注意点 <a id="SS_8_10"></a>
### オーバーライドとオーバーロードの違い <a id="SS_8_10_1"></a>
...
### danglingリファレンス <a id="SS_8_10_2"></a>
...
### danglingポインタ <a id="SS_8_10_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_8_10_2)と同じような状態になったポインタを指す。


### Most Vexing Parse <a id="SS_8_10_4"></a>
...
## ソフトウェア一般 <a id="SS_8_11"></a>
### ヒープ <a id="SS_8_11_1"></a>
...
### ハンドル <a id="SS_8_11_7"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

### フリースタンディング環境 <a id="SS_8_11_8"></a>
...
#### 凝集性の欠如 <a id="SS_8_11_10_1"></a>
[凝集性](cpp_idioms.md#SS_8_11_10)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
#### LCOM <a id="SS_8_11_10_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_8_11_10_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。

### Spurious Wakeup <a id="SS_8_11_11"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_8_11_12"></a>
静的初期化順序問題とは、
...
### Itanium C++ ABI <a id="SS_8_11_14"></a>
...
[g++](cpp_idioms.md#SS_8_12_1)や[clang++](cpp_idioms.md#SS_8_12_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_8_13"></a>
### セマンティクス <a id="SS_8_13_1"></a>
