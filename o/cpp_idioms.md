...
&emsp;&emsp;&emsp; [メモリ保護機構](cpp_idioms.md#SS_8_12_9)  
&emsp;&emsp;&emsp; [CPU例外](cpp_idioms.md#SS_8_12_10)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](cpp_idioms.md#SS_8_12_11)  
&emsp;&emsp;&emsp; [凝集性](cpp_idioms.md#SS_8_12_12)  
&emsp;&emsp;&emsp;&emsp; [凝集性の欠如](cpp_idioms.md#SS_8_12_12_1)  
&emsp;&emsp;&emsp;&emsp; [LCOM](cpp_idioms.md#SS_8_12_12_2)  

&emsp;&emsp;&emsp; [Spurious Wakeup](cpp_idioms.md#SS_8_12_13)  
&emsp;&emsp;&emsp; [Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_8_12_14)  
&emsp;&emsp;&emsp; [副作用](cpp_idioms.md#SS_8_12_15)  
&emsp;&emsp;&emsp; [Itanium C++ ABI](cpp_idioms.md#SS_8_12_16)  
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_8_12_11)によって下記テーブルのように定義する。
...
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_8_12_12_2)によって下記テーブルのように定義する。
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_8_12_9)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
#### 凝集性の欠如 <a id="SS_8_12_12_1"></a>
[凝集性](cpp_idioms.md#SS_8_12_12)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
#### LCOM <a id="SS_8_12_12_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_8_12_12_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。

### Spurious Wakeup <a id="SS_8_12_13"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_8_12_14"></a>
静的初期化順序問題とは、
...
### Itanium C++ ABI <a id="SS_8_12_16"></a>
