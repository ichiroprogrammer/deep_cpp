...
&emsp;[ガード節(Early Return)](cpp_idioms.md#SS_8_1_1)  
&emsp;[前方宣言ヘッダ(`_fwd.h`)](cpp_idioms.md#SS_8_1_2)  
&emsp;[RAII(scoped guard)](cpp_idioms.md#SS_8_1_3)  
&emsp;[Copy-And-Swap](cpp_idioms.md#SS_8_1_4)  
&emsp;[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_8_1_5)  
&emsp;[Accessor](cpp_idioms.md#SS_8_1_6)  
&emsp;[Immutable](cpp_idioms.md#SS_8_1_7)  
&emsp;[NVI(non virtual interface)](cpp_idioms.md#SS_8_1_8)  

[実装パターン](cpp_idioms.md#SS_8_2)  
&emsp;[Pimpl](cpp_idioms.md#SS_8_2_1)  
&emsp;[lightweight Pimpl](cpp_idioms.md#SS_8_2_2)  
&emsp;[BitmaskType](cpp_idioms.md#SS_8_2_3)  
&emsp;[Future](cpp_idioms.md#SS_8_2_4)  
&emsp;[Null Object](cpp_idioms.md#SS_8_2_5)  
&emsp;[Cでのクラス表現](cpp_idioms.md#SS_8_2_6)  

[オブジェクト指向](cpp_idioms.md#SS_8_3)  
&emsp;[is-a](cpp_idioms.md#SS_8_3_1)  
&emsp;[has-a](cpp_idioms.md#SS_8_3_2)  
&emsp;[is-implemented-in-terms-of](cpp_idioms.md#SS_8_3_3)  
&emsp;&emsp;[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_8_3_3_1)  
&emsp;&emsp;[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_8_3_3_2)  
&emsp;&emsp;[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_8_3_3_3)  

[オブジェクトの所有権](cpp_idioms.md#SS_8_4)  
&emsp;[オブジェクトの排他所有](cpp_idioms.md#SS_8_4_1)  
&emsp;[オブジェクトの共有所有](cpp_idioms.md#SS_8_4_2)  
&emsp;[オブジェクトの循環所有](cpp_idioms.md#SS_8_4_3)  

[copy/moveと等価性のセマンティクス](cpp_idioms.md#SS_8_5)  
&emsp;[等価性のセマンティクス](cpp_idioms.md#SS_8_5_1)  
&emsp;[copyセマンティクス](cpp_idioms.md#SS_8_5_2)  
&emsp;[moveセマンティクス](cpp_idioms.md#SS_8_5_3)  
&emsp;[MoveAssignable要件](cpp_idioms.md#SS_8_5_4)  
&emsp;[CopyAssignable要件](cpp_idioms.md#SS_8_5_5)  

[関数設計のガイドライン](cpp_idioms.md#SS_8_6)  
&emsp;[関数の引数と戻り値の型](cpp_idioms.md#SS_8_6_1)  
&emsp;[サイクロマティック複雑度のクライテリア](cpp_idioms.md#SS_8_6_2)  
&emsp;[関数の行数のクライテリア](cpp_idioms.md#SS_8_6_3)  

[クラス設計のガイドライン](cpp_idioms.md#SS_8_7)  
&emsp;[ゼロの原則(Rule of Zero)](cpp_idioms.md#SS_8_7_1)  
&emsp;[五の原則(Rule of Five)](cpp_idioms.md#SS_8_7_2)  
&emsp;[クラス凝集性のクライテリア](cpp_idioms.md#SS_8_7_3)  

[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_8_8)  
&emsp;[リリース等価の原則(REP)](cpp_idioms.md#SS_8_8_1)  
&emsp;[共通閉鎖の原則(CCP)](cpp_idioms.md#SS_8_8_2)  
&emsp;[共通再利用の原則(CRP)](cpp_idioms.md#SS_8_8_3)  
&emsp;[非循環依存の原則(ADP)](cpp_idioms.md#SS_8_8_4)  

[コード・ユニット](cpp_idioms.md#SS_8_9)  
&emsp;[ファイルペア](cpp_idioms.md#SS_8_9_1)  
&emsp;&emsp;[パッケージ内のファイルペアの配置](cpp_idioms.md#SS_8_9_1_1)  

&emsp;[パッケージ](cpp_idioms.md#SS_8_9_2)  
&emsp;[モジュール](cpp_idioms.md#SS_8_9_3)  

[Modern CMake project layout](cpp_idioms.md#SS_8_10)  
&emsp;[Modern CMake project layoutのカスタマイズ](cpp_idioms.md#SS_8_10_1)  

[コーディングスタイル](cpp_idioms.md#SS_8_11)  
&emsp;[AAAスタイル](cpp_idioms.md#SS_8_11_1)  
&emsp;[east-const](cpp_idioms.md#SS_8_11_2)  
&emsp;[west-const](cpp_idioms.md#SS_8_11_3)  
&emsp;[Trailing Underscore(末尾アンダースコア)](cpp_idioms.md#SS_8_11_4)  
&emsp;[ケース記法](cpp_idioms.md#SS_8_11_5)  
&emsp;&emsp;[スネークケース(snake_case)](cpp_idioms.md#SS_8_11_5_1)  
&emsp;&emsp;[アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_8_11_5_2)  
&emsp;&emsp;[アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_8_11_5_3)  
&emsp;&emsp;[ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_8_11_5_4)  
&emsp;&emsp;[ケバブケース(kebab-case)](cpp_idioms.md#SS_8_11_5_5)  

[オブジェクトのコピー](cpp_idioms.md#SS_8_12)  
&emsp;[シャローコピー](cpp_idioms.md#SS_8_12_1)  
&emsp;[ディープコピー](cpp_idioms.md#SS_8_12_2)  
&emsp;[スライシング](cpp_idioms.md#SS_8_12_3)  

[C++注意点](cpp_idioms.md#SS_8_13)  
&emsp;[オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_8_13_1)  
&emsp;[danglingリファレンス](cpp_idioms.md#SS_8_13_2)  
&emsp;[danglingポインタ](cpp_idioms.md#SS_8_13_3)  
&emsp;[Most Vexing Parse](cpp_idioms.md#SS_8_13_4)  
&emsp;[Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_8_13_5)  
&emsp;[Unbounded Functions](cpp_idioms.md#SS_8_13_6)  

[ソフトウェア一般](cpp_idioms.md#SS_8_14)  
&emsp;[ヒープ](cpp_idioms.md#SS_8_14_1)  
&emsp;[プライオリティインバージョン](cpp_idioms.md#SS_8_14_2)  
&emsp;[スレッドセーフ](cpp_idioms.md#SS_8_14_3)  
&emsp;[リエントラント](cpp_idioms.md#SS_8_14_4)  
&emsp;[クリティカルセクション](cpp_idioms.md#SS_8_14_5)  
&emsp;[スピンロック](cpp_idioms.md#SS_8_14_6)  
&emsp;[ミックスイン](cpp_idioms.md#SS_8_14_7)  
&emsp;[ハンドル](cpp_idioms.md#SS_8_14_8)  
&emsp;[フリースタンディング環境](cpp_idioms.md#SS_8_14_9)  
&emsp;[メモリ保護機構](cpp_idioms.md#SS_8_14_10)  
&emsp;[CPU例外](cpp_idioms.md#SS_8_14_11)  
&emsp;[Fluent Interface](cpp_idioms.md#SS_8_14_12)  
&emsp;[サイクロマティック複雑度](cpp_idioms.md#SS_8_14_13)  
&emsp;[凝集性](cpp_idioms.md#SS_8_14_14)  
&emsp;&emsp;[凝集性の欠如](cpp_idioms.md#SS_8_14_14_1)  
&emsp;&emsp;[LCOM](cpp_idioms.md#SS_8_14_14_2)  
&emsp;&emsp;[PercentLackOfCohesion](cpp_idioms.md#SS_8_14_14_3)  

&emsp;[Spurious Wakeup](cpp_idioms.md#SS_8_14_15)  
&emsp;[副作用](cpp_idioms.md#SS_8_14_16)  
&emsp;[Itanium C++ ABI](cpp_idioms.md#SS_8_14_17)  

[C++コンパイラ](cpp_idioms.md#SS_8_15)  
&emsp;[g++](cpp_idioms.md#SS_8_15_1)  
&emsp;[clang++](cpp_idioms.md#SS_8_15_2)  

[非ソフトウェア用語](cpp_idioms.md#SS_8_16)  
&emsp;[セマンティクス](cpp_idioms.md#SS_8_16_1)  
&emsp;[割れ窓理論](cpp_idioms.md#SS_8_16_2)  
&emsp;[車輪の再発明](cpp_idioms.md#SS_8_16_3)  

[DAG(有向非循環グラフ)](cpp_idioms.md#SS_8_17)  
...
### 前方宣言ヘッダ(`_fwd.h`) <a id="SS_8_1_2"></a>
...
### RAII(scoped guard) <a id="SS_8_1_3"></a>
...
### CRTP(curiously recurring template pattern) <a id="SS_8_1_5"></a>
CRTPとは、
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_8_14_7)の例を示す。
...
一方で、「[Accessor](cpp_idioms.md#SS_8_1_6)」で紹介したsetterは、クラスのimmutabilityを下げる。
...
### NVI(non virtual interface) <a id="SS_8_1_8"></a>
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_8_16_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_8_14_8)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_8_12_3)が起こるためである。
...
* エクセプション安全性  
    [no-fail保証](core_lang_spec.md#SS_6_13_7_1)をする(noexceptと宣言し、エクセプションをthrowしない)
...
[注]
`templat<typename T> f(T&&)`の`T&&`は[forwardingリファレンス](core_lang_spec.md#SS_6_8_3)である。  
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_8_14_13)によって下記テーブルのように定義する。
...
リソース管理を専門とするクラス
(例: 標準ライブラリの[RAII(scoped guard)](cpp_idioms.md#SS_8_1_3)クラス)に任せる設計ガイドラインを指す。
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_8_12_1)」参照)。
...
クラス構造の適・不適については、[PercentLackOfCohesion](cpp_idioms.md#SS_8_14_14_3)によって下記テーブルのように定義することができる。
...
## Robert C. Martinのコンポーネント原則 <a id="SS_8_8"></a>
...
それと一体で判断すべき依存構造の原則 [非循環依存の原則(ADP)](cpp_idioms.md#SS_8_8_4)を用いる。

| 原則                           | 一文での定義                             | 視点   | 力の向き／作用   |
|:------------------------------ |:-----------------------------------------|:-------|:-----------------|
| [リリース等価の原則(REP)](cpp_idioms.md#SS_8_8_1) | リリースノートが一本の筋として書けるか   | 提供側 | 凝集（まとめる） |
| [共通閉鎖の原則(CCP)](cpp_idioms.md#SS_8_8_2)     | 変更される理由が一つか                   | 提供側 | 凝集（まとめる） |
| [共通再利用の原則(CRP)](cpp_idioms.md#SS_8_8_3)   | 利用者に不要な依存まで抱えさせていないか | 利用側 | 分割（割る）     |
 
### リリース等価の原則(REP) <a id="SS_8_8_1"></a>
...
CCPは、[リリース等価の原則(REP)](cpp_idioms.md#SS_8_8_1)と同様に「パッケージをまとめることの根拠」になり得る。

### 共通再利用の原則(CRP) <a id="SS_8_8_3"></a>
...
[インターフェース分離の原則(ISP)](solid.md#SS_2_4)をライブラリ粒度へ適用したものに相当する。
[リリース等価の原則(REP)](cpp_idioms.md#SS_8_8_1)/[共通閉鎖の原則(CCP)](cpp_idioms.md#SS_8_8_2)とは逆に、「パッケージを分割することの根拠」になり得る。


### 非循環依存の原則(ADP) <a id="SS_8_8_4"></a>
ADPとは、Acyclic Dependencies Principle(非循環依存の原則)の略称であり、
ライブラリ間の依存関係に循環を作ってはならない、という原則である。
依存グラフは後述の[DAG(有向非循環グラフ)](cpp_idioms.md#SS_8_17)でなければならない。
循環があると、ライブラリを独立してビルド・テスト・リリースすることが困難になる。

---

## コード・ユニット <a id="SS_8_9"></a>
...
|ヘッダファイル|`*.h` `*.hpp` `*.hxx`                                                                           |
|実装ファイル  |`*.c` `*.cpp` `*.cxx`                                                                           |
|ファイルペア  |`name.h`と`name.c`の組み合わせ /「[ファイルペア](cpp_idioms.md#SS_8_9_1)」で解説                                   |
|モジュール    |モジュール ≒  パッケージ / 「[モジュール](cpp_idioms.md#SS_8_9_3)」で解説                                          |
|パッケージ    |「[パッケージ](cpp_idioms.md#SS_8_9_2)」で解説 / CMake([Modern CMake project layout](cpp_idioms.md#SS_8_10))のビルド単位(ライブラリ) |

ここでは、これらの概念に意味と定義を与える。

- ファイルペア ＝ １つの実装ファイルとヘッダファイル(稀に、実装ファイルやヘッダファイルのみ)
- パッケージ(CMakeのビルド単位) ≒  [Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_8_8)における「コンポーネント」
- パッケージ(CMakeのビルド単位) ∋  (複数の似た機能を持つ)ファイルペア


### ファイルペア <a id="SS_8_9_1"></a>
...
- ファイルペアのファイルの配置は、「[パッケージ内のファイルペアの配置](cpp_idioms.md#SS_8_9_1_1)」で示す。 


#### パッケージ内のファイルペアの配置 <a id="SS_8_9_1_1"></a>
パッケージ内でのファイルペアのヘッダの配置は以下の２パターンのみでなければならない。

- [ファイルペアの機能をパッケージ内部でのみ使用する場合](cpp_idioms.md#SS_8_9_1_1_1)
- [ファイルペアの機能をパッケージが外部公開する場合](cpp_idioms.md#SS_8_9_1_1_2)

##### ファイルペアの機能をパッケージ内部でのみ使用する場合 <a id="SS_8_9_1_1_1"></a>
...
##### ファイルペアの機能をパッケージが外部公開する場合 <a id="SS_8_9_1_1_2"></a>
...
### パッケージ <a id="SS_8_9_2"></a>
このドキュメントでのパッケージとは、以下の特徴を持つソースコードツリーである。 

- **類似した機能**を持つ複数の[ファイルペア](cpp_idioms.md#SS_8_9_1)の集合体
- パッケージのソースコードは、専用のディレクトリの配下に配置され、[Modern CMake project layout](cpp_idioms.md#SS_8_10)と同等の形状を持つ。
- パッケージは専用の名前空間を持つ。
- パッケージのビルド生成物はライブラリである。
- ライブラリ粒度の凝集性は、関数レベル/クラスの古典的凝集度分類ではなく、[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_8_8)
  (「[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_8_8)」のコンポーネントとはこのドキュメントではパッケージを指す)で判断する。
  中核は次の三原則のパワーバランスである。
    - [リリース等価の原則(REP)](cpp_idioms.md#SS_8_8_1)
    - [共通閉鎖の原則(CCP)](cpp_idioms.md#SS_8_8_2)
    - [共通再利用の原則(CRP)](cpp_idioms.md#SS_8_8_3)
...
- **CRP は利用側の問い**: 「利用者はこれを丸ごと使うか。使わない物まで巻き込ませていないか？」。  
  パッケージ版の[インターフェース分離の原則(ISP)](solid.md#SS_2_4)と考えて差し支えない。
...
とし、[パッケージ](cpp_idioms.md#SS_8_9_2)としてその粒度を詳細に定義付けている。

__[注]__:
ここでのモジュールとC++20で導入された[モジュール](core_lang_spec.md#SS_6_10_2)は似た概念であるが、異なるものである。

--- 

## Modern CMake project layout <a id="SS_8_10"></a>
...
### Modern CMake project layoutのカスタマイズ <a id="SS_8_10_1"></a>
このドキュメントでは、以下の方針に基づいて[Modern CMake project layout](cpp_idioms.md#SS_8_10)の構成をカスタマイズすることを推奨する。
...
## コーディングスタイル <a id="SS_8_11"></a>
### AAAスタイル <a id="SS_8_11_1"></a>
...
### Trailing Underscore(末尾アンダースコア) <a id="SS_8_11_4"></a>
...
### ケース記法 <a id="SS_8_11_5"></a>
C++の識別子の命名規則(Naming convention)を以下のようにリストアップする。

* [スネークケース(snake_case)](cpp_idioms.md#SS_8_11_5_1)
* [アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_8_11_5_2)
* [アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_8_11_5_3)
* [ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_8_11_5_4)
* [ケバブケース(kebab-case)](cpp_idioms.md#SS_8_11_5_5)

#### スネークケース(snake_case) <a id="SS_8_11_5_1"></a>
...
#### アッパースネークケース(UPPER_SNAKE_CASE) <a id="SS_8_11_5_2"></a>
...
#### アッパーキャメルケース(UpperCamelCase) <a id="SS_8_11_5_3"></a>
...
#### ロワーキャメルケース(lowerCamelCase) <a id="SS_8_11_5_4"></a>
...
#### ケバブケース(kebab-case) <a id="SS_8_11_5_5"></a>
...
## オブジェクトのコピー <a id="SS_8_12"></a>
### シャローコピー <a id="SS_8_12_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_8_12_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_8_12_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_8_12_1)が発生させる問題を回避したコピーである。
...
## C++注意点 <a id="SS_8_13"></a>
### オーバーライドとオーバーロードの違い <a id="SS_8_13_1"></a>
...
### danglingリファレンス <a id="SS_8_13_2"></a>
...
### danglingポインタ <a id="SS_8_13_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_8_13_2)と同じような状態になったポインタを指す。


---

### Most Vexing Parse <a id="SS_8_13_4"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_8_13_5"></a>
静的初期化順序問題とは、
...
### Unbounded Functions <a id="SS_8_13_6"></a>
...
## ソフトウェア一般 <a id="SS_8_14"></a>
### ヒープ <a id="SS_8_14_1"></a>
...
### プライオリティインバージョン <a id="SS_8_14_2"></a>
...
### スレッドセーフ <a id="SS_8_14_3"></a>
スレッドセーフとは「複数のスレッドから同時にアクセスされても、
排他制御などの機構([std::mutex](stdlib_and_concepts.md#SS_7_4_2))により共有データの整合性が保たれ、正しく動作する性質」である。

---

### リエントラント <a id="SS_8_14_4"></a>
リエントラントとは「実行中に同じ関数が再度呼び出されても、グローバル変数や静的変数に依存せず、
ローカル変数のみで動作するため正しく動作する性質」である。

一般に、リエントラントな関数は[スレッドセーフ](cpp_idioms.md#SS_8_14_3)であるが、逆は成り立たない。

---

### クリティカルセクション <a id="SS_8_14_5"></a>
複数のスレッドから同時にアクセスされると競合状態を引き起こす可能性があるコード領域をクリティカルセクションと呼ぶ。
典型的には、共有変数や共有データ構造を読み書きするコード部分がこれに該当する。
クリティカルセクションは、[std::mutex](stdlib_and_concepts.md#SS_7_4_2)等の排他制御機構によって保護し、
一度に一つのスレッドのみが実行できるようにする必要がある。

---

### スピンロック <a id="SS_8_14_6"></a>
スピンロックとは、
...
C++11では、スピンロックは[std::atomic](stdlib_and_concepts.md#SS_7_4_3)を使用して以下のように定義できる。
...
以下の単体テスト(「[std::mutex](stdlib_and_concepts.md#SS_7_4_2)」の単体テストを参照)
に示したように[std::scoped_lock](stdlib_and_concepts.md#SS_7_5_3)のテンプレートパラメータとして使用できる。
...
### ミックスイン <a id="SS_8_14_7"></a>
ミックスインとは、オブジェクト指向プログラミングにおいて、
複数のクラスに対して特定の機能やメソッドを提供するための設計パターンである。
「混ぜ込む（mix in）」という名称が示すとおり、既存のクラスに機能を追加する目的で使用される。

C++では[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_8_1_5)や通常の継承によってミックスインを実現する。

---

### ハンドル <a id="SS_8_14_8"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

---

### フリースタンディング環境 <a id="SS_8_14_9"></a>
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_8_14_10)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
### Fluent Interface <a id="SS_8_14_12"></a>
...
### サイクロマティック複雑度 <a id="SS_8_14_13"></a>
[サイクロマティック複雑度](https://ja.wikipedia.org/wiki/%E5%BE%AA%E7%92%B0%E7%9A%84%E8%A4%87%E9%9B%91%E5%BA%A6)
とは関数の複雑さを表すメトリクスである。

---

### 凝集性 <a id="SS_8_14_14"></a>
[凝集性(凝集度)](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、「[PercentLackOfCohesion](cpp_idioms.md#SS_8_14_14_3)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_8_14_14_1)メトリクスの値が100に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
* メンバ変数やメンバ関数が多くなれば、凝集性は低くなりやすい。
* 凝集性は、クラスのメンバがどれだけ一貫した責任を持つかを示す。
* 「[単一責任の原則(SRP)](solid.md#SS_2_1)」を守ると凝集性は高くなりやすい。
* 「[Accessor](cpp_idioms.md#SS_8_1_6)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集性は低くなる。
   従って、下記のようなクラスは凝集性が低い。言い換えれば、凝集性を下げることなく、
   より小さいクラスに分割できる。
   なお、以下のクラスでは、実際に計測すると、[PercentLackOfCohesion](cpp_idioms.md#SS_8_14_14_3)が100に近い値となっている。
...
(ただし、「[Immutable](cpp_idioms.md#SS_8_1_7)」の観点からは、QuadraticEquation::Set()がない方が良い)。
...
#### 凝集性の欠如 <a id="SS_8_14_14_1"></a>
[凝集性の欠如](cpp_idioms.md#SS_8_14_14_1)とはLack of Cohesion in Methodsの和訳であり、[LCOM](cpp_idioms.md#SS_8_14_14_2)と呼ばれる。

LCOMはメソッドペアの数に基づく非正規化の整数値であるため、
メソッド数が多いクラスほど値が大きくなりやすく、クラス間で単純に値の大小を比較することはできない。
この弱点を補う指標として実務上広く用いられるのが、[PercentLackOfCohesion](cpp_idioms.md#SS_8_14_14_3)である。
...
#### PercentLackOfCohesion <a id="SS_8_14_14_3"></a>
厳密性を欠くが、クラスの凝集性を測定するためには、
テクマトリックス社製のUnderstandのメトリクスPercentLackOfCohesionを使用するのが実践的である。

PercentLackOfCohesionは、[LCOM](cpp_idioms.md#SS_8_14_14_2)と同様に使用できるメトリクスであり、0〜100に正規化された値である。

[クラス凝集性のクライテリア](cpp_idioms.md#SS_8_7_3)に示した通り、構造的欠陥をを持つクラスの自動的な抽出に有用である。

---

### Spurious Wakeup <a id="SS_8_14_15"></a>
...
### Itanium C++ ABI <a id="SS_8_14_17"></a>
...
[g++](cpp_idioms.md#SS_8_15_1)や[clang++](cpp_idioms.md#SS_8_15_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_8_16"></a>
### セマンティクス <a id="SS_8_16_1"></a>
