...
&emsp;&emsp; [コンテナ](stdlib_and_concepts.md#SS_7_6)  
&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_7_6_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward_list](stdlib_and_concepts.md#SS_7_6_1_1)  

&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_7_6_2)  
&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_7_6_3)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_set](stdlib_and_concepts.md#SS_7_6_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_map](stdlib_and_concepts.md#SS_7_6_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_index](stdlib_and_concepts.md#SS_7_6_3_3)  

&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_7_6_4)  
&emsp;&emsp;&emsp; [特殊なコンテナ](stdlib_and_concepts.md#SS_7_6_5)  

&emsp;&emsp; [std::optional](stdlib_and_concepts.md#SS_7_7)  
&emsp;&emsp;&emsp; [戻り値の無効表現](stdlib_and_concepts.md#SS_7_7_1)  
&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_7_7_2)  

&emsp;&emsp; [std::variant](stdlib_and_concepts.md#SS_7_8)  
&emsp;&emsp; [オブジェクトの比較](stdlib_and_concepts.md#SS_7_9)  
&emsp;&emsp;&emsp; [std::rel_ops](stdlib_and_concepts.md#SS_7_9_1)  
&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_7_9_2)  

&emsp;&emsp; [その他](stdlib_and_concepts.md#SS_7_10)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](stdlib_and_concepts.md#SS_7_10_1)  
&emsp;&emsp;&emsp; [heap allocation elision](stdlib_and_concepts.md#SS_7_10_2)  
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_7_6_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_7_6_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_7_6_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_7_6_5)
...
| [std::forward_list](stdlib_and_concepts.md#SS_7_6_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
...
| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_7_6_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_7_6_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](stdlib_and_concepts.md#SS_7_6_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_7_7_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_7_7_2)する(初期化処理が重く、
