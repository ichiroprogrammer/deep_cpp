...
&emsp;&emsp;&emsp; [std::enable_shared_from_this](stdlib_and_concepts.md#SS_7_5_3)  
&emsp;&emsp;&emsp; [std::weak_ptr](stdlib_and_concepts.md#SS_7_5_4)  
&emsp;&emsp;&emsp; [std::auto_ptr](stdlib_and_concepts.md#SS_7_5_5)  
...
[クリティカルセクション](cpp_idioms.md#SS_8_11_4)と呼ぶ)が、std::mutexによりこの問題を回避している。
...
最も単純な使用例を以下に示す(「[Spurious Wakeup](cpp_idioms.md#SS_8_11_11)」参照)。
```cpp
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_8_11_11)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_8_11_11)の対策が行われていないため、
意図通り動作しない可能性がある。
...
* [std::shared_ptr](stdlib_and_concepts.md#SS_7_5_2)
    - [std::enable_shared_from_this](stdlib_and_concepts.md#SS_7_5_3)
    - [std::weak_ptr](stdlib_and_concepts.md#SS_7_5_4)
* [std::auto_ptr](stdlib_and_concepts.md#SS_7_5_5)
...
[std::weak_ptr](stdlib_and_concepts.md#SS_7_5_4)は、shared_ptrと連携して使用されるスマートポインタであり、オブジェクトの非所有参照を表す。
参照カウントには影響せず、循環参照を防ぐために用いられる。weak_ptrから一時的にshared_ptrを取得するにはlock()を使用する。

### std::enable_shared_from_this <a id="SS_7_5_3"></a>
