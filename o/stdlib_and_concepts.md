...
[ユーティリティ](stdlib_and_concepts.md#SS_7_1)  
&emsp;[std::move](stdlib_and_concepts.md#SS_7_1_1)  
&emsp;[std::forward](stdlib_and_concepts.md#SS_7_1_2)  

[type_traits](stdlib_and_concepts.md#SS_7_2)  
&emsp;[std::integral_constant](stdlib_and_concepts.md#SS_7_2_1)  
&emsp;[std::true_type](stdlib_and_concepts.md#SS_7_2_2)  
&emsp;[std::false_type](stdlib_and_concepts.md#SS_7_2_3)  
&emsp;[std::is_same](stdlib_and_concepts.md#SS_7_2_4)  
&emsp;[std::enable_if](stdlib_and_concepts.md#SS_7_2_5)  
&emsp;[std::conditional](stdlib_and_concepts.md#SS_7_2_6)  
&emsp;[std::is_void](stdlib_and_concepts.md#SS_7_2_7)  
&emsp;[std::is_copy_assignable](stdlib_and_concepts.md#SS_7_2_8)  
&emsp;[std::is_move_assignable](stdlib_and_concepts.md#SS_7_2_9)  

[標準エクセプションクラス](stdlib_and_concepts.md#SS_7_3)  
&emsp;[std::exception](stdlib_and_concepts.md#SS_7_3_1)  

[並列処理](stdlib_and_concepts.md#SS_7_4)  
&emsp;[std::thread](stdlib_and_concepts.md#SS_7_4_1)  
&emsp;[std::mutex](stdlib_and_concepts.md#SS_7_4_2)  
&emsp;[std::atomic](stdlib_and_concepts.md#SS_7_4_3)  
&emsp;[std::condition_variable](stdlib_and_concepts.md#SS_7_4_4)  

[ロック所有ラッパー](stdlib_and_concepts.md#SS_7_5)  
&emsp;[std::lock_guard](stdlib_and_concepts.md#SS_7_5_1)  
&emsp;[std::unique_lock](stdlib_and_concepts.md#SS_7_5_2)  
&emsp;[std::scoped_lock](stdlib_and_concepts.md#SS_7_5_3)  

[スマートポインタ](stdlib_and_concepts.md#SS_7_6)  
&emsp;[std::unique_ptr](stdlib_and_concepts.md#SS_7_6_1)  
&emsp;&emsp;[std::make_unique](stdlib_and_concepts.md#SS_7_6_1_1)  

&emsp;[std::shared_ptr](stdlib_and_concepts.md#SS_7_6_2)  
&emsp;&emsp;[std::make_shared](stdlib_and_concepts.md#SS_7_6_2_1)  
&emsp;&emsp;[std::enable_shared_from_this](stdlib_and_concepts.md#SS_7_6_2_2)  

&emsp;[std::weak_ptr](stdlib_and_concepts.md#SS_7_6_3)  
&emsp;[std::auto_ptr](stdlib_and_concepts.md#SS_7_6_4)  

[Polymorphic Memory Resource(pmr)](stdlib_and_concepts.md#SS_7_7)  
&emsp;[std::pmr::memory_resource](stdlib_and_concepts.md#SS_7_7_1)  
&emsp;[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_7_7_2)  
&emsp;[pool_resource](stdlib_and_concepts.md#SS_7_7_3)  

[コンテナ](stdlib_and_concepts.md#SS_7_8)  
&emsp;[シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_7_8_1)  
&emsp;&emsp;[std::forward_list](stdlib_and_concepts.md#SS_7_8_1_1)  

&emsp;[連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_7_8_2)  
&emsp;[無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_7_8_3)  
&emsp;&emsp;[std::unordered_set](stdlib_and_concepts.md#SS_7_8_3_1)  
&emsp;&emsp;[std::unordered_map](stdlib_and_concepts.md#SS_7_8_3_2)  
&emsp;&emsp;[std::type_index](stdlib_and_concepts.md#SS_7_8_3_3)  

&emsp;[コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_7_8_4)  
&emsp;[特殊なコンテナ](stdlib_and_concepts.md#SS_7_8_5)  

[std::optional](stdlib_and_concepts.md#SS_7_9)  
&emsp;[戻り値の無効表現](stdlib_and_concepts.md#SS_7_9_1)  
&emsp;[オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_7_9_2)  

[std::variant](stdlib_and_concepts.md#SS_7_10)  
[オブジェクトの比較](stdlib_and_concepts.md#SS_7_11)  
&emsp;[std::rel_ops](stdlib_and_concepts.md#SS_7_11_1)  
&emsp;[std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_7_11_2)  

[その他](stdlib_and_concepts.md#SS_7_12)  
&emsp;[SSO(Small String Optimization)](stdlib_and_concepts.md#SS_7_12_1)  
&emsp;[heap allocation elision](stdlib_and_concepts.md#SS_7_12_2)  
...
## 標準エクセプションクラス <a id="SS_7_3"></a>
C++標準ライブラリは、`<exception>`と`<stdexcept>`定義される標準エクセプションクラスを提供する。

### std::exception <a id="SS_7_3_1"></a>
...
[クリティカルセクション](cpp_idioms.md#SS_8_14_5)と呼ぶ)が、std::mutexによりこの問題を回避している。
...
mutexは通常、[std::lock_guard](stdlib_and_concepts.md#SS_7_5_1)と組み合わせて使われる。

### std::atomic <a id="SS_7_4_3"></a>
atomicクラステンプレートは、型Tをアトミック操作するためのものである。
[組み込み型](core_lang_spec.md#SS_6_1_2)に対する特殊化が提供されており、それぞれに特化した演算が用意されている。
[std::mutex](stdlib_and_concepts.md#SS_7_4_2)で示したような単純なコードではstd::atomicを使用して下記のように書く方が一般的である。
...
### std::condition_variable <a id="SS_7_4_4"></a>
condition_variable は、特定のイベントが発生するまでスレッドの待ち合わせを行うためのクラスである。
最も単純な使用例を以下に示す(「[Spurious Wakeup](cpp_idioms.md#SS_8_14_15)」参照)。
...
## ロック所有ラッパー <a id="SS_7_5"></a>
ロック所有ラッパーとはミューテックスのロックおよびアンロックを管理するための以下のクラスを指す。

- [std::lock_guard](stdlib_and_concepts.md#SS_7_5_1)
- [std::unique_lock](stdlib_and_concepts.md#SS_7_5_2)
- [std::scoped_lock](stdlib_and_concepts.md#SS_7_5_3)


### std::lock_guard <a id="SS_7_5_1"></a>
...
### std::unique_lock <a id="SS_7_5_2"></a>
...
下記のコード例では、[std::lock_guard](stdlib_and_concepts.md#SS_7_5_1)の説明で述べたようにmutex::lock()、mutex::unlock()を直接呼び出すのではなく、
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_8_14_15)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_8_14_15)の対策が行われていないため、
意図通り動作しない可能性がある。
...
### std::scoped_lock <a id="SS_7_5_3"></a>
...
* [std::unique_ptr](stdlib_and_concepts.md#SS_7_6_1)
    - [std::make_unique](stdlib_and_concepts.md#SS_7_6_1_1)
* [std::shared_ptr](stdlib_and_concepts.md#SS_7_6_2)
    - [std::make_shared](stdlib_and_concepts.md#SS_7_6_2_1)
    - [std::enable_shared_from_this](stdlib_and_concepts.md#SS_7_6_2_2)
    - [std::weak_ptr](stdlib_and_concepts.md#SS_7_6_3)
* [std::auto_ptr](stdlib_and_concepts.md#SS_7_6_4)

### std::unique_ptr <a id="SS_7_6_1"></a>
...
#### std::make_unique <a id="SS_7_6_1_1"></a>
...
### std::shared_ptr <a id="SS_7_6_2"></a>
...
[std::weak_ptr](stdlib_and_concepts.md#SS_7_6_3)は、shared_ptrと連携して使用されるスマートポインタであり、オブジェクトの非所有参照を表す。
参照カウントには影響せず、循環参照を防ぐために用いられる。weak_ptrから一時的にshared_ptrを取得するにはlock()を使用する。

#### std::make_shared <a id="SS_7_6_2_1"></a>
...
#### std::enable_shared_from_this <a id="SS_7_6_2_2"></a>
...
### std::weak_ptr <a id="SS_7_6_3"></a>
std::weak_ptrは、スマートポインタの一種である。

std::weak_ptrは参照カウントに影響を与えず、[std::shared_ptr](stdlib_and_concepts.md#SS_7_6_2)とオブジェクトを共有所有するのではなく、
...
なお、上記コードは[初期化付きif文](core_lang_spec.md#SS_6_9_4_3)を使うことで、
...
## Polymorphic Memory Resource(pmr) <a id="SS_7_7"></a>
Polymorphic Memory Resource(pmr)は、
動的メモリ管理の柔軟性と効率性を向上させるための、C++17から導入された仕組みである。

[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_7_7_2)はC++17で導入された標準ライブラリのクラスで、
...
* [std::pmr::memory_resource](stdlib_and_concepts.md#SS_7_7_1)  
* [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_7_7_2)  
* [pool_resource](stdlib_and_concepts.md#SS_7_7_3)

### std::pmr::memory_resource <a id="SS_7_7_1"></a>
std::pmr::memory_resourceは、
ユーザー定義のメモリリソースをカスタマイズし、
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_7_7_2)を通じて利用可能にする[インターフェースクラス](core_lang_spec.md#SS_6_4_11)である。
...
### std::pmr::polymorphic_allocator <a id="SS_7_7_2"></a>
std::pmr::polymorphic_allocatorはC++17で導入された標準ライブラリのクラスで、
C++のメモリリソース管理を抽象化するための機能を提供する。
[std::pmr::memory_resource](stdlib_and_concepts.md#SS_7_7_1)を基盤とし、
コンテナやアルゴリズムにカスタムメモリアロケーション戦略を容易に適用可能にする。
std::allocatorと異なり、型に依存せず、
ポリモーフィズムを活用してメモリリソースを切り替えられる点が特徴である。

すでに示したmemory_resource_variable([std::pmr::memory_resource](stdlib_and_concepts.md#SS_7_7_1))の単体テストを以下に示すことにより、
...
### pool_resource <a id="SS_7_7_3"></a>
pool_resourceは[std::pmr::memory_resource](stdlib_and_concepts.md#SS_7_7_1)を基底とする下記の2つの具象クラスである。
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_7_8_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_7_8_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_7_8_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_7_8_5)

### シーケンスコンテナ(Sequence Containers) <a id="SS_7_8_1"></a>
...
| [std::forward_list](stdlib_and_concepts.md#SS_7_8_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
| `std::array`             | 固定長配列で、サイズがコンパイル時に決まる                          |
| `std::string`            | 可変長の文字列を管理するクラス(厳密には`std::basic_string`の特殊化) |

#### std::forward_list <a id="SS_7_8_1_1"></a>
...
### 連想コンテナ(Associative Containers) <a id="SS_7_8_2"></a>
...
### 無順序連想コンテナ(Unordered Associative Containers) <a id="SS_7_8_3"></a>
ハッシュテーブルを基盤としたコンテナで、順序を保証しないが高速な検索を提供する。

| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_7_8_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_7_8_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](stdlib_and_concepts.md#SS_7_8_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |

#### std::unordered_set <a id="SS_7_8_3_1"></a>
...
#### std::unordered_map <a id="SS_7_8_3_2"></a>
...
#### std::type_index <a id="SS_7_8_3_3"></a>
...
### コンテナアダプタ(Container Adapters) <a id="SS_7_8_4"></a>
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_7_9_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_7_9_2)する(初期化処理が重く、
   条件によってはそれが無駄になる場合にこの機能を使う)

### 戻り値の無効表現 <a id="SS_7_9_1"></a>
...
## オブジェクトの比較 <a id="SS_7_11"></a>
### std::rel_ops <a id="SS_7_11_1"></a>
...
### std::tuppleを使用した比較演算子の実装方法 <a id="SS_7_11_2"></a>
...
## その他 <a id="SS_7_12"></a>
### SSO(Small String Optimization) <a id="SS_7_12_1"></a>
...
### heap allocation elision <a id="SS_7_12_2"></a>
