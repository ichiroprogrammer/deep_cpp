...
&emsp;&emsp;&emsp; [CTAD（Class Template Argument Deduction）](core_lang_spec.md#SS_6_11_17)  
&emsp;&emsp;&emsp; [戻り値型を後置する関数宣言](core_lang_spec.md#SS_6_11_18)  
&emsp;&emsp;&emsp; [関数の戻り値型auto](core_lang_spec.md#SS_6_11_19)  
&emsp;&emsp;&emsp; [後置戻り値型auto](core_lang_spec.md#SS_6_11_20)  
...
ポリモーフィックなクラスは、
仮想関数呼び出しを行う(「[オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_8_7_1)」参照)
ためのメモリレイアウトが必要になる。
...
各クラスがvtblへのポインタを保持するため、このドキュメントで使用している[g++](cpp_idioms.md#SS_8_9_1)では、
...
このドキュメントのコードのコンパイルに使用している[g++](cpp_idioms.md#SS_8_9_1)/[clang++](cpp_idioms.md#SS_8_9_2)では、
...
* [ゼロの原則(Rule of Zero)](cpp_idioms.md#SS_8_4_1)
* [五の原則(Rule of Five)](cpp_idioms.md#SS_8_4_2)
...
といった[セマンティクス](cpp_idioms.md#SS_8_10_1)的観点によるものである。
...
「[std::tuppleを使用した比較演算子の実装方法](standard_lib_programming_concepts.md#SS_7_9_2)」
...
主要なメタ関数は標準ライブラリの[type_traits](standard_lib_programming_concepts.md#SS_7_2)で定義されている。
...
C++14から導入された[関数の戻り値型auto](core_lang_spec.md#SS_6_11_19)と似た、
...
サンプルコードを[g++](cpp_idioms.md#SS_8_9_1)と[clang++](cpp_idioms.md#SS_8_9_2)でコンパイルしている)。
...
によるとこの動作は未定義のようだが、
[g++](cpp_idioms.md#SS_8_9_1)/[clang++](cpp_idioms.md#SS_8_9_2)両方ともこのコードを警告なしでコンパイルする)。
...
このテストはエラーとならなければならないが、[g++](cpp_idioms.md#SS_8_9_1)ではパスしてしまう。
2nd name lookupのロジックにバグがあるようである。

有難いことに、[clang++](cpp_idioms.md#SS_8_9_2)では仕様通りこのテストはエラーとなり、
